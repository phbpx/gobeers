...
// Strings returns a string representation of the database configuration.
...
func Opens(cfg Config) (*bun.DB, error) {
...
func StatusChecks(ctx context.Context, db *bun.DB) error {
...
// IsErrIntegrityViolation chec if the error code is one of the following:
//
